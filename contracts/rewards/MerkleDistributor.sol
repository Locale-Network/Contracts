...
contract MerkleDistributor is IMerkleDistributor {
  ...
  function acceptGrant(
    ...
    /// https://github.com/ethereum/solidity/blob/v^0.8.11/docs/abi-spec.rst#non-standard-packed-mode,
    /// it is important that no more than one of the arguments to `abi.encodePacked()` here be a
    /// dynamic type (see definition in
    /// https://github.com/ethereum/solidity/blob/v^0.8.11/docs/abi-spec.rst#formal-specification-of-the-encoding).
