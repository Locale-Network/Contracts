...
/**
 * @title LocaleLending's Borrower contract
 * @notice These contracts represent the a convenient way for a borrower to interact with LocaleLending
 ...
 *  This contract is the "official" borrower contract that will be maintained by LocaleLending governance. However,
