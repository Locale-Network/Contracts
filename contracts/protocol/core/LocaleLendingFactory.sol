...
/**
 * @title LocaleLendingFactory
 * @notice Contract that allows us to create other contracts, such as CreditLines and BorrowerContracts
 *  Note LocaleLendingFactory is a legacy name. More properly this can be considered simply the LocaleLendingFactory
 * @author LocaleLending
 */

contract LocaleLendingFactory is BaseUpgradeablePausable {
