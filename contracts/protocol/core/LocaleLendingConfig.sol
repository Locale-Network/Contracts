...
import "../../interfaces/ILocaleLendingConfig.sol";
import "./ConfigOptions.sol";

/**
 * @title LocaleLendingConfig
...
contract LocaleLendingConfig is BaseUpgradeablePausable {
  ...
  function setLocaleLendingConfig(address newAddress) public onlyAdmin {
  ...
  function initializeFromOtherConfig(
    ...
    ILocaleLendingConfig initialConfig = ILocaleLendingConfig(_initialConfig);
