...
/// @notice Enables the transfer of LLP rewards (referred to as a "grant"), if the grant details exist in this
/// contract's Merkle root.
interface IMerkleDirectDistributor {
  /// @notice Returns the address of the LLP contract that is the token distributed as rewards by
  ///   this contract.
